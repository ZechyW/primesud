...
# VNUM ranges: 3700-3799
# Credits: { 1  5} Hatchet Mud School


AREA = {
    "name":     'mud school',
    "builders": '{ 1  5} Hatchet Mud School',
    "vnums":    (3700, 3799),
    "credits":  '{ 1  5} Hatchet Mud School',
    "levels":   (1, 5),
}
...
MOBILES = {
    ...
    M_BLOB: {
        ...
        "start_pos":   'stand',
        "default_pos": 'stand',
        "form_flags": {"poison": True, "blob": True, "cold_blood": True},
        "material": '0',
        "sex":    'none',
        "wealth": 0,
        "size":   'large',
    ...
    M_FOX: {
        ...
        "armor":     (8, 8, 8, 10),
        "off_flags": {"trip": True, "assist_race": True},
        "start_pos":   'stand',
        "default_pos": 'stand',
        "material": '0',
        "sex":    'either',
    ...
    M_SNAIL: {
        ...
        "start_pos":   'stand',
        "default_pos": 'stand',
        "form_flags": {"edible": True, "animal": True, "crustacean": True, "cold_blood": True},
        "part_flags": {"head": True, "guts": True, "feet": True, "eyestalks": True},
        "material": '0',
        "sex":    'none',
        "wealth": 0,
        "size":   'tiny',
    ...
    M_BEAST: {
        ...
        "race":        'school monster',
        "act_flags": {"aggressive": True, "warrior": True},
    ...
    M_BEAR: {
        ...
        "armor":     (6, 5, 6, 7),
        "off_flags": {"bash": True, "assist_race": True},
        "start_pos":   'stand',
        "default_pos": 'stand',
        "material": '0',
        "sex":    'either',
...
ROOMS = {
    R_ENTRANCE_TO_MUD_SCHOOL: {
        ...
        "exits": {
            ...
            "s": {"to": R_NORTH_WALL_OF_ARENA_3744, "desc": 'You see the one way door into the Arena of Mud School.', "keyword": 'door', "isdoor": True, "closed": True},
    ...
    R_ROOM_IN_MUD_SCHOOL_3717: {
        ...
        "exits": {
            "e": {"to": R_ROOM_IN_MUD_SCHOOL_3719, "desc": 'You see the next station of Mud School.', "keyword": 'door', "isdoor": True, "closed": True},
    ...
    R_ROOM_IN_MUD_SCHOOL_3719: {
        ...
        "exits": {
            ...
            "e": {"to": R_END_OF_MUD_SCHOOL, "desc": 'You see the next station of Mud School.', "keyword": 'door', "isdoor": True, "closed": True, "locked": True, "pickproof": True, "key": 3714},
            "w": {"to": R_ROOM_IN_MUD_SCHOOL_3717, "desc": 'You see the room you just came from.', "keyword": 'door', "isdoor": True, "closed": True},
        },
        "flags": {"no_mob": True, "indoors": True, "newbies_only": True},
        "sector": 'inside',
    ...
    R_END_OF_MUD_SCHOOL: {
        ...
        "exits": {
            "n": {"to": R_SOUTH_WALL_OF_ARENA, "desc": 'You see the Arena ahead.', "keyword": 'gate', "isdoor": True, "closed": True},
        },
        "flags": {"indoors": True, "newbies_only": True},
        "sector": 'inside',
    ...
    R_CENTER_OF_ARENA: {
        ...
        "exits": {
            ...
            "w": R_ARENA_3733,
            "u": {"to": R_SAFE_ROOM, "desc": 'You see the EXIT.'},
            "d": {"to": R_CENTER_OF_THE_DUNGEON, "desc": 'You see a dark murky dungeon below.', "keyword": 'grate', "isdoor": True, "closed": True},
        },
        "flags": {"indoors": True},
        "sector": 'inside',
    ...
    R_CENTER_OF_THE_DUNGEON: {
        ...
        "exits": {
            ...
            "u": {"to": R_CENTER_OF_ARENA, "desc": 'You see safety!', "keyword": 'grate', "isdoor": True, "closed": True},
        },
        "flags": {"indoors": True},
        "sector": 'inside',
    },
...
OBJECTS = {
    ...
    I_STAFF_SUB_MERC: {
        ...
        "stat_bonuses": {'hitroll': 2, 'damroll': 1},
...
SHOPS = (
    {"keeper": M_ADEPT_CLERIC_3717, "buy_types": ['light', 'container', 'drink', 'food'], "profit_buy": 100, "profit_sell": 100, "open_hour": 0, "close_hour": 23},
)
