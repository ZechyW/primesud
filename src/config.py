...
VERSION = "1.0.2"  # [PRIMESUD] shown by do_version; upstream has no PrimeSUD-side equivalent
...
REVEAL_MS_PER_LINE = 20                       # [PRIMESUD] streaming output reveal, per text row; 0 disables
