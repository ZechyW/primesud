...
const struct flag_stat_type flag_stat_table[] = {
	...
	{STNM(social_flags), false},
	{STNM(song_flags), false},
	{STNM(skill_flags), false},
	{STNM(group_flags), false},
	{STNM(channel_flags), false},
	{STNM(color_flags), false},
	{STNM(help_flags), false},
	{STNM(race_flags), false},
	{STNM(class_flags), false},
	{STNM(deity_flags), false},
	{STNM(custom_colors), true},
	{NULL, NULL, 0}
};

int is_stat(FlagTable * flag_table)
{
	int flag;
...
flag_t flag_value(FlagTable * flag_table, const char *argument)
{
	FlagTable *f;
	flag_t marked;
	bool found = false;
...
const char *flag_string(FlagTable * flag_table, flag_t bits)
{
...
char *flagtable_names(FlagTable * flag_table)
{
	static int i;
