...
Proto(void init_color_data, (colatt_t *));
Proto(void set_default_color, (colatt_t *, int, ColorTemplate *));
Proto(void default_color, (CharData *, int));
Proto(color_value_t random_color, (color_attr_t));
Proto(void convert_random, (colatt_t *));
Proto(void show_greeting, (Descriptor *));
Proto(void color_convert_prefix, (char, char *));
...
ProtoF(const char *stringf,
	   (CharData *, size_t, align_t, char *, const char *, ...), 5, 6);
...
ProtoF(void new_wiznet,
	   (CharData *, const void *, flag_t, bool, int, const char *, ...), 6,
	   7);
...
Proto(void act_new,
	  (const char *, CharData *, const void *, const void *, flag_t,
	   position_t));
Proto(void perform_act,
	  (const char *, CharData *, const void *, const void *, flag_t,
	   CharData *));
...
Proto(const char *string_replace, (const char *, const char *, const char *));
...
Proto(void program_flow,
	  (ProgList * program, CharData *, ObjData *, RoomIndex *, CharData *,
	   const void *arg1, const void *));
Proto(void p_act_trigger,
	  (const char *, CharData *, ObjData *, RoomIndex *, CharData *,
	   const void *, const void *, flag_t));

Proto(bool p_percent_trigger,
	  (CharData *, ObjData *, RoomIndex *, CharData *, const void *,
	   const void *, flag_t));
Proto(void p_bribe_trigger, (CharData *, CharData *, money_t));

Proto(bool p_exit_trigger, (CharData *, int, prog_t));
Proto(void p_give_trigger,
	  (CharData *, ObjData *, RoomIndex *, CharData *, ObjData *, flag_t));
...
Proto(void set_on_off,
	  (CharData *, flag_t *, flag_t, const char *, const char *));
...
Proto(void portal_chat,
	  (CharData *, CharData *, const char *, const char *, const char *));

Proto(void send_imp, (Descriptor *, char *));

ProtoF(void send_pueblo, (CharData *, const char *, ...), 2, 3);

Proto(void image_to_char, (CharData *, const char *));
Proto(void send_sound, (CharData *, MspData *));
Proto(void send_music, (CharData *, MspData *));
Proto(void act_sound,
	  (MspData *, CharData *, const void *, flag_t, position_t));

Proto(size_t get_line_len, (const char *, size_t));
Proto(char *erase_new_lines, (const char *));
...
Proto(int chwrap, (CharData *, const char *));
Proto(int chwrapln, (CharData *, const char *));
ProtoF(int chwrapf, (CharData *, const char *, ...), 2, 3);
ProtoF(int chwraplnf, (CharData *, const char *, ...), 2, 3);
...
Proto(void personal_message,
	  (const char *, const char *, const char *, const int, const char *));
Proto(void make_note,
	  (const char *, const char *, const char *, const char *, const int,
	   const char *, const char *, const char *));
Proto(void append_to_note,
	  (CharData *, const char *, const char *, const char *, const char *,
...
#ifndef HAVE_SCANDIR
Proto(int scandir,
	  (const char *, struct dirent ***, int (*select) (const struct dirent *),
...
Proto(void gettimeofday, (struct timeval *, void *));
#endif
...
Proto(char *is_invalid_email, (const char *));

Proto(bool has_whitespace, (const char *));
Proto(bool wild_match, (const char *, const char *));
Proto(void examine_crash_log, (void));
Proto(char *path_to_area, (CharData *, AreaData *));

#ifndef DISABLE_MYSQL

Proto(int db_insert_mob, (bool, CharIndex *));
Proto(int db_insert_obj, (bool, ObjIndex *));
Proto(int db_insert_room, (bool, RoomIndex *));
Proto(int db_insert_area, (bool, AreaData *));
Proto(int db_insert_progs,
	  (bool, AreaData *, ProgList *, vnum_t, const char *));
Proto(int db_insert_descs,
	  (bool, AreaData *, ExDescrData *, vnum_t, const char *));
Proto(int db_insert_specials, (bool, AreaData *, Spec_F *, vnum_t));
Proto(int db_insert_exits, (bool, AreaData *, ExitData *, vnum_t));
Proto(int db_insert_shop, (bool, ShopData *));
Proto(int db_insert_objaffects, (bool, AreaData *, ObjIndex *));
Proto(int db_insert_resets, (bool, RoomIndex *));
Proto(int db_insert_helps, (void));
Proto(int db_load_helps, (void));
Proto(int db_insert_commands, (void));
Proto(int db_load_commands, (void));
Proto(int db_insert_socials, (void));
Proto(int db_load_socials, (void));
Proto(int db_insert_skills, (void));
Proto(int db_load_skills, (void));
Proto(void db_del_area, (AreaData *));
Proto(void db_start, (void));
Proto(void db_stop, (void));
Proto(void db_load_areas, (void));
Proto(void init_db_first_run, (void));
Proto(void finish_db_first_run, (void));

#endif

Proto(void create_default_color_scheme, (void));
Proto(ColorTemplate * find_color_template, (const char *));
Proto(bool set_custom_color,
	  (const char *, CharData *, colatt_t *, const char *));
Proto(void realloc_channel_history, (PcData *, int, int, int));
Proto(const char *format_channel, (ChannelData *, CharData *));
