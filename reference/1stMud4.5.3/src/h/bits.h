...
#define DISABLE_EXTENDED_ASCII_CHARS	(BIT_F)
#define DISABLE_TILDE_CONVERSION	(BIT_G)
#define DISABLE_AREA_RECALL	(BIT_H)
#define DISABLE_AUTODAM	(BIT_I)
#define DISABLE_AUTOMAP	(BIT_J)
#define DISABLE_AGGRO_MOBS	(BIT_K)
#define DISABLE_AREA_DIRECTIONS	(BIT_L)
...
#define CLAN_INDEPENDENT	(BIT_C)
#define CLAN_NO_PK	(BIT_D)
#define CLAN_IMMORTAL	(BIT_E)
#define CLAN_FAVOURED	(BIT_F)
...
#define OLC_NONE	0
#define OLC_CHANGED	(BIT_A)
#define OLC_DELETED	(BIT_B)

#define AREA_ADDED	(BIT_C)
#define AREA_LOADING	(BIT_D)
#define AREA_PLAYER_HOMES	(BIT_E)
#define AREA_CLOSED	(BIT_F)
...
#define CMD_NOPREFIX	(BIT_C)
#define CMD_NO_ORDER	(BIT_D)
#define CMD_NOALIAS	(BIT_E)

#define COLOR_IMMORTAL	(BIT_C)
