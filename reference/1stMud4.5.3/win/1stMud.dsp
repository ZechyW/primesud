...
OutDir=.\..\bin
SOURCE="$(InputPath)"
PreLink_Cmds=if exist $(OUTDIR)\1stMud.exe.old cd $(OUTDIR) && del 1stMud.exe.old	if exist $(OUTDIR)\1stMud.exe cd $(OUTDIR) && rename 1stMud.exe 1stMud.exe.old
